...
{
	/// <summary>
	/// Verifies that <see cref="SqliteProviderOperations.QuoteIdentifier"/> throws
	...
	/// SQLite uses double-quote identifier quoting.
	/// </summary>
	...
	/// <summary>
	/// Verifies that <see cref="SqliteProviderOperations.QuoteIdentifier"/> wraps the identifier in
	/// double-quotes and escapes embedded double-quotes by doubling them.
	/// </summary>
