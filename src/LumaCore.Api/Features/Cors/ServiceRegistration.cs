...
/// </summary>
/// <remarks>
/// This class configures Cross-Origin Resource Sharing based on the <see cref="CorsOptions"/> configuration.
/// </remarks>
static class ServiceRegistration
{
	...
	/// <remarks>
	/// This is a convenience wrapper that forwards to <see cref="AddCorsFeatureCore"/> using the
