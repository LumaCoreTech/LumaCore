...
interface IAsyncWaitQueue<T>
{
	...
	/// This method may only be called if <see cref="IsEmpty"/> is <see langword="false"/>.
	/// The task continuations for the completed task must be executed asynchronously.
	/// </summary>
	/// <param name="result">
	/// The result used to complete the wait queue entry. If this isn't needed, use
	...
	/// </summary>
	/// <param name="result">
	/// The result used to complete the wait queue entries. If this isn't needed, use
	/// <see langword="default"/>.
	/// </param>
