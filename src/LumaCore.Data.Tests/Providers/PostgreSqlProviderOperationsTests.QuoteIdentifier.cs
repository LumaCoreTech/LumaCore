...
{
	/// <summary>
	/// Verifies that <see cref="PostgreSqlProviderOperations.QuoteIdentifier"/> throws
	...
	/// <summary>
	/// Verifies that <see cref="PostgreSqlProviderOperations.QuoteIdentifier"/> wraps the identifier in
