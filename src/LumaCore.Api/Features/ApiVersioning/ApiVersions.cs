...
/// <remarks>
///     <para>
///     This class serves as the single source of truth for all supported API versions. All version definitions should
///     be added here to ensure consistency across the application and to make version management straightforward.
///     </para>
///     <para>When adding a new API version:</para>
///     <list type="number">
///         <item>
///             <description>Add a new <see cref="ApiVersion"/> constant in this class.</description>
///         </item>
///         <item>
///             <description>
///             Register the version in <see cref="VersionedApiGroup.MapVersionedApiGroup"/> using <c>HasApiVersion()</c>
///             or <c>HasDeprecatedApiVersion()</c>.
///             </description>
///         </item>
///         <item>
///             <description>
///             Use <c>MapToApiVersion()</c> in your feature's endpoint mapping to bind endpoints to the new version.
///             </description>
///         </item>
///     </list>
/// </remarks>
static class ApiVersions
{
	...
	/// </summary>
	/// <remarks>
	///     <para>This version includes all foundational endpoints:</para>
	///     <list type="bullet">
	...
	///     </list>
	///     <para>
	///     Every endpoint MUST specify its version(s) explicitly via <c>MapToApiVersion()</c>. The application
